    ...
    class ModeloNoticia extends Model
    {
        ...
        public function obtenerHistorialNoticia($idNoticia) {
            ...
            ->select('estado_noticia.fecha, estado_noticia.observaciones, usuario.correo as responsable, 
                    estado.nombre as estado, usuario.id as id_usuario, estado_noticia.id_estado as id_estado')
            ->get()->getResultArray();
        }
        ...
        public function obtenerNoticiasParaValidar(){
            ...
            return $this->db->table($this->tablaBorrador)
                    ...
                    ->groupBy('noticia.id')
                    ->select('noticia.id, borrador.titulo, categoria.nombre as categoria, borrador.imagen, estado_noticia.fecha, usuario.correo')
                    ->get()->getResultArray();
        }
        ...
        public function obtenerNoticiasEstadoPublicada(){
